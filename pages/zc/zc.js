...
Page({
  ...
  hqyzm:function(){
    ...
    var that = this, url = app.globalData.comurl + "&m=Asset&a=send_code", data = { phone:that.data.sjh }, method = 'post';
  ...
  tj:function(){
   if(this.data.tdm==''){
    ...
    var that = this, url = app.globalData.comurl + "&m=Heroes&a=personal", data = { token: app.globalData.token, team: that.data.tdm, sname: that.data.nichen, tel: that.data.sjh }, data1 = { token: app.globalData.token, openid: wx.getStorageSync('openid'), team: that.data.tdm, sname: that.data.nichen, tel: that.data.sjh }, method = 'post';
